...
def banner():
	print (''' %s 
%sHANNAN HANNAN%s ---FACEBOOK*-*-MD MAINUL ISLAM
 %sHANNAN HANNAN %s----Note*-*-CLONING IS NOT A CRIME ITS 
  %sHANNAN HANNAN%s--*-*--JUST WAR AGAINST THE SYSTEM
   %sHANNAN  HANNAN%s----*-*----OWNER:)(: MAINUL-ISLAM
    %sHANNAN HANNAN
     %sHANNAN HANNAN
      %sHANNAN HANNAN
       %sHANNAN HANNAN
                ...
                if pwx == '':
                    ...
                    def zona(zafi_=None): 
                        ...
                        if ind == '':
                            ...
                            print '\n %s[%s*%s] MAINUL %sOK%s SAVE IN  >%s hasil/OK-%s-%s-%s.txt'%(P,K,P,H,P,H,ha, op, ta);jeda(0.2)
                            print '%s [%s*%s] MAINUL %sCP %sSAVE IN> %shasil/CP-%s-%s-%s.txt'%(P,K,P,K,P,K,ha, op, ta);jeda(0.2)
...
def igg():
	print ("\n%s [%s!%s] EX : name%s: %MAINUL "%(P,M,P,M,K))
	...
	print '\n%s [%s*%s] MAINUL%sOK%s SAVE IN >%s OK.txt'%(P,K,P,H,P,H);jeda(0.2)
	print '%s [%s*%s] MAINUL %sCP %SAVE IN > %sCP.txt\n'%(P,K,P,K,P,K);jeda(0.2)
	with ThreadPoolExecutor(max_workers=30) as log:
		for ro in mi:
			try:
				_bff_ = []
